...
public class RemoveInstitutePDF {

    public static void main(String[] args) throws IOException {

        String sourceDir = "F:\\GCCTBC-APR 2026\\Photocopy folder\\marathi\\PDF_UNIQUE";
        String targetDir = "F:\\GCCTBC-APR 2026\\Photocopy folder\\marathi\\STD_PDF_UNIQUE";
        ...
        for (File file : files) {
            ...
            if (!seatNumberSet.contains(seatNumber) && seatNumber.length()<=10) {
