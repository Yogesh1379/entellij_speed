...
public class Marathi_EnterAndTabCount3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File studentFolder = new File("F:\\GCCTBC December2025\\Marking\\Eng 40\\Diff_SpeedAnswer\\New folder");
        ...
        for (File studentFile : docxFiles) {
            ...
            summaryRun.addCarriageReturn();
            summaryRun.setText("Extra Enter (3+): " + maxBlankSequence);
            summaryRun.addCarriageReturn();
